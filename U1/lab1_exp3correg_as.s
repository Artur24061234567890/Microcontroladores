...
inicio:
    ...
    movwf   val1            ; Mover el valor de PORTB a val1
    movlw   0x0C            ; Cargar 0x0C en WREG
...
check2:
    movlw   0x0A            ; Cargar 0x0A en WREG
    cpfseq  val1            ; Comparar con 00001010B (0x0A)
    goto    check3          ; Si no es igual, revisar la siguiente
    bsf     LATD, 0         ; Si es igual, encender la bomba
    goto    inicio

check3:
    movlw   0x08            ; Cargar 0x08 en WREG
    cpfseq  val1            ; Comparar con 00001000B (0x08)
