...
void main()
{
    ...
    while(1)
    {
        if(PORTBbits.RB4 == 0)              //Espera activa a que B4 sea presionado
        {
            LATFbits.LATF3 = 1;             //Apagamos el led (lógica negativa)
        }
        else                                //Al soltar el pulsador B4
        {
            LATFbits.LATF3 = 0;             //El led se queda encendido
        }
